...
public final class ATBitmapUtils {
    ...
    public static Bitmap createBitmap(Context context, byte[] imageByte, int orientatoin) {
        ...
        BitmapFactory.Options opts = new BitmapFactory.Options();
//        try {
//            int width = ATDensityUtils.getDisplayWidth(context);
//            int hight = ATDensityUtils.getDisplayHeight(context);
//            int min = Math.min(width, hight);
//            opts.inJustDecodeBounds = false;
//            bitmap = BitmapFactory.decodeByteArray(imageByte, 0, imageByte.length);
//            transformed = ATBitmapUtils.rotateBitmap(orientatoin, bitmap);
//        } catch (OutOfMemoryError e) {
//            e.printStackTrace();
//            if (bitmap != null) {
//                bitmap.recycle();
