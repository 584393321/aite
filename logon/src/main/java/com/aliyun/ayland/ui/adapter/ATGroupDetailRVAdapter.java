...
public class ATGroupDetailRVAdapter extends RecyclerView.Adapter {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private ATMyCircleImageView mATMyCircleImageView;
        ...
        public ViewHolder(View itemView) {
            ...
            mATMyCircleImageView = itemView.findViewById(R.id.myCircleImageView);
        }

        public void setData(int position) {
            mTvName.setText(list.get(position).getNickName());
            Glide.with(mContext).load(list.get(position).getAvatarUrl()).apply(options).into(mATMyCircleImageView);
        }
    }
}