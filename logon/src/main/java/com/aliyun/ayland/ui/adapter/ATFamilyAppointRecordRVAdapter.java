...
import com.aliyun.ayland.data.ATFamilyAppointRecordBean;
import com.anthouse.xuhui.R;

import java.util.ArrayList;
import java.util.List;

public class ATFamilyAppointRecordRVAdapter extends RecyclerView.Adapter {
    private Activity mContext;
    private List<ATFamilyAppointRecordBean> list = new ArrayList<>();

    public ATFamilyAppointRecordRVAdapter(Activity context) {
        mContext = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.at_item_rv_family_appoint_record, parent, false);
    ...
    public void setLists(List<ATFamilyAppointRecordBean> list, int pageNum) {
        if (pageNum == 0)
            this.list.clear();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView mTvName, mTvAddress, mTvPlan, mTvReality;
        ...
        public ViewHolder(View itemView) {
            ...
            mTvReality = itemView.findViewById(R.id.tv_reality);
        }
        ...
        public void setData(int position) {
            ...
            if (TextUtils.isEmpty(list.get(position).getActualStartTimeStr())) {
                mTvReality.setText(mContext.getString(R.string.at_unknown));
            } else {
                mTvReality.setText(list.get(position).getActualStartTimeStr()
