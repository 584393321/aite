 ...
 */
public class ATHomeActivity extends ATBaseActivity implements ATSceneContract.View {
    ...
    protected void findView() {
        ...
        llInside = findViewById(R.id.ll_inside);
        smartRefreshLayout = findViewById(R.id.smartRefreshLayout);
        rvShortcut = findViewById(R.id.rv_shortcut);
        rvApplication = findViewById(R.id.rv_application);
        imgPmRed = findViewById(R.id.img_pm_red);
        imgPmYello = findViewById(R.id.img_pm_yello);
        imgPmInsideRed = findViewById(R.id.img_pm_inside_red);
        imgPmInsideYello = findViewById(R.id.img_pm_inside_yello);
        imgTvocRed = findViewById(R.id.img_tvoc_red);
        imgTvocYello = findViewById(R.id.img_tvoc_yello);
        imgBegin = findViewById(R.id.img_begin);
        imgTo = findViewById(R.id.img_to);
        imgEnd = findViewById(R.id.img_end);
        llWeather = findViewById(R.id.ll_weather);
        llWeather1 = findViewById(R.id.ll_weather1);
        tvOutsideTemp = findViewById(R.id.tv_outside_temp);
        tvWind = findViewById(R.id.tv_wind);
        tvWeather = findViewById(R.id.tv_weather);
        tvPm = findViewById(R.id.tv_pm);
        tvCity = findViewById(R.id.tv_city);
        tvInsideTemp = findViewById(R.id.tv_inside_temp);
        tvWet = findViewById(R.id.tv_wet);
        tvPmInside = findViewById(R.id.tv_pm_inside);
        tvTvoc = findViewById(R.id.tv_tvoc);
        tvAddBox = findViewById(R.id.tv_add_box);
...
//        llWeather1.setOnClickListener(view -> startActivity(new Intent(getActivity(), ATEnvironmentActivity.class)));
//        llWeather.setOnClickListener(view -> startActivity(new Intent(getActivity(), ATEnvironmentActivity.class)));

        rvShortcut.setLayoutManager(new ATSmoothnessLayoutManage(this, LinearLayout.HORIZONTAL, false));
        mATHomeShortcutRVAdapter = new ATHomeShortcutRVAdapter(this);
        mATHomeShortcutRVAdapter.setOnItemClickListener((view, position) -> {
            if (position == mShortcutList.size() - 1) {
                //更多
                startActivityForResult(new Intent(this, ATHomeShortcutActivity.class)
        ...
        mHomeAppRVAdapter = new ATHomeCardRVAdapter(this);
    ...
    private SpannableString setSizeSpan(String s) {
        ...
        textSpan.setSpan(new AbsoluteSizeSpan(12, true), s.length() - 1, s.length(), Spannable.SPAN_INCLUSIVE_INCLUSIVE);
        return textSpan;
    }
...
//        textSpan.setSpan(new AbsoluteSizeSpan(14, true), s.length() - 5, s.length(), Spannable.SPAN_INCLUSIVE_INCLUSIVE);
    ...
    private void initQRCodeDialog() {
        mDialogQRCode = new Dialog(this, R.style.nameDialog);
...
//        getAppList();
    ...
    private void getWeather() {
        ...
        ATHouseBean ATHouseBean = gson.fromJson(ATGlobalApplication.getHouse(), com.aliyun.ayland.data.ATHouseBean.class);
        JSONObject jsonObject = new JSONObject();
...
//                        mATLoginBean.setAvatarUrl(ATUserInfoBean.getAvatarUrl());
                    ...
                    case ATConstants.Config.SERVER_URL_GETWEATHER:
                        ...
                        runOnUiThread(this::requestComplete);
                        break;
