...
public final class ATCameraConfigurationManager {
	...
	public void setDesiredCameraParameters(Camera camera, boolean safeMode) {
		...
		if (parameters == null) {
			Log.w(TAG, "ATDevice error: no camera parameters are available. Proceeding without configuration.");
			return;
		}
	...
	private Point findBestPreviewSizeValue(Camera.Parameters parameters, Point screenResolution) {
		...
		if (rawSupportedSizes == null) {
			Log.w(TAG, "ATDevice returned no supported preview sizes; using default");
