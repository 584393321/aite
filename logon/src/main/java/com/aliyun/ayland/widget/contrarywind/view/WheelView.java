...
import com.aliyun.ayland.widget.contrarywind.timer.InertiaTimerTask;
import com.aliyun.ayland.widget.contrarywind.timer.MessageHandler;
import com.aliyun.ayland.widget.contrarywind.timer.SmoothScrollTimerTask;
...
public class WheelView extends View {
    ...
    private ATOnItemSelectedListener mATOnItemSelectedListener;
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            textColorOut = a.getColor(R.styleable.pickerview_wheelview_textColorOut, 0xFF666666);
            textColorCenter = a.getColor(R.styleable.pickerview_wheelview_textColorCenter, 0xFF333333);
            dividerColor = a.getColor(R.styleable.pickerview_wheelview_dividerColor, 0xFFFDA448);
    ...
    public final void setATOnItemSelectedListener(ATOnItemSelectedListener ATOnItemSelectedListener) {
        this.mATOnItemSelectedListener = ATOnItemSelectedListener;
    }
    ...
    public final void onItemSelected() {
        if (mATOnItemSelectedListener != null) {
            postDelayed(new Runnable() {
                @Override
                public void run() {
                    mATOnItemSelectedListener.onItemSelected(getCurrentItem());
                }
            }, 200L);
        }
    }
