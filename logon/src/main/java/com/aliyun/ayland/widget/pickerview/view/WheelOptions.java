...
public class WheelOptions<T> {
    ...
    public void setPicker(List<T> options1Items,
        ...
        if (options1Items != null && linkage) {
            wv_option1.setATOnItemSelectedListener(wheelListener_option1);
        }
        if (options2Items != null && linkage) {
            wv_option2.setATOnItemSelectedListener(wheelListener_option2);
        }
        if (options3Items != null && linkage && optionsSelectChangeListener != null) {
            wv_option3.setATOnItemSelectedListener(new ATOnItemSelectedListener() {
                @Override
                public void onItemSelected(int index) {
    ...
    public void setNPicker(List<T> options1Items, List<T> options2Items, List<T> options3Items) {
        ...
        if (optionsSelectChangeListener != null) {
            wv_option1.setATOnItemSelectedListener(new ATOnItemSelectedListener() {
                @Override
                public void onItemSelected(int index) {
        ...
        if (options2Items == null) {
            ...
            wv_option2.setVisibility(View.VISIBLE);
            if (optionsSelectChangeListener != null) {
                wv_option2.setATOnItemSelectedListener(new ATOnItemSelectedListener() {
                    @Override
                    public void onItemSelected(int index) {
