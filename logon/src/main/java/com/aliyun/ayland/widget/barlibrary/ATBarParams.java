 ...
 */
public class ATBarParams implements Cloneable {
    @ColorInt
    ...
    public ATBarHide barHide = ATBarHide.FLAG_SHOW_BAR;  //隐藏Bar
    ...
    public ATKeyboardPatch keyboardPatch;        //软键盘监听类
    public ATOnKeyboardListener onKeyboardListener;   //软键盘监听类
    public ContentObserver navigationStatusObserver;  //emui3.1监听器

    @Override
    protected ATBarParams clone() {
        ATBarParams barParams = null;
        try {
            barParams = (ATBarParams) super.clone();
