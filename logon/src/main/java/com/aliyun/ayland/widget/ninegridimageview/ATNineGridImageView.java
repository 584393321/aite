 ...
 */
public class ATNineGridImageView<T> extends ViewGroup {
    ...
    private ATNineGridImageViewAdapter<T> mAdapter;
    private ATItemImageClickListener<T> mATItemImageClickListener;
    private ATItemImageLongClickListener<T> mATItemImageLongClickListener;

    public ATNineGridImageView(Context context) {
        this(context, null);
    }

    public ATNineGridImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ATNineGridImageView);
        this.mGap = (int) typedArray.getDimension(R.styleable.ATNineGridImageView_imgGap, 0);
        this.mSingleImgSize = typedArray.getDimensionPixelSize(R.styleable.ATNineGridImageView_singleImgSize, -1);
        this.mShowStyle = typedArray.getInt(R.styleable.ATNineGridImageView_showStyle, STYLE_GRID);
        this.mMaxSize = typedArray.getInt(R.styleable.ATNineGridImageView_maxSize, 9);
        typedArray.recycle();
    }
            ...
            if (mAdapter != null) {
                ...
                imageView.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (mATItemImageClickListener != null) {
                            mATItemImageClickListener.onItemImageClick(getContext(), (ImageView) v, position, mImgDataList);
                        }
                    }
                });
                imageView.setOnLongClickListener(new OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        ...
                        if (mATItemImageLongClickListener != null) {
                            consumedEvent = mATItemImageLongClickListener.onItemImageLongClick(getContext(), (ImageView) v, position, mImgDataList) || consumedEvent;
                        }
                ...
                Log.e("NineGirdImageView", "Your must set a ATNineGridImageViewAdapter for NineGirdImageView");
                return null;
            }
        }
    }
     ...
     * @param adapter 适配器
     */
    public void setAdapter(ATNineGridImageViewAdapter adapter) {
        mAdapter = adapter;
    }
    ...
    public void setATItemImageClickListener(ATItemImageClickListener<T> itemImageViewClickListener) {
        mATItemImageClickListener = itemImageViewClickListener;
    }

    public void setATItemImageLongClickListener(ATItemImageLongClickListener<T> itemImageViewLongClickListener) {
        mATItemImageLongClickListener = itemImageViewLongClickListener;
    }
}