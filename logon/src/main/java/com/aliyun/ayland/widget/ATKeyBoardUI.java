...
public class ATKeyBoardUI implements ATKeyBoardHeightUtils.KeyBoardHigthListener {
    ...
    private ATKeyBoardHeightUtils mATKeyBoardHeightUtils;
    ...
    private ATKeyBoardUI(Activity activity) {
        ...
        getScreen();
        initDialog();
        mATKeyBoardHeightUtils = ATKeyBoardHeightUtils.setKeyBoardHeigthListener(activity, this);
    }
    ...
    public void removeKeyboardHeightListener() {
        mATKeyBoardHeightUtils.removeKeyboardHeightListener();
    }
}