...
import com.aliyun.ayland.widget.pickerview.adapter.ArrayWheelAdapter;
import com.aliyun.ayland.widget.pickerview.adapter.NumericWheelAdapter;
import com.aliyun.ayland.widget.pickerview.listener.ISelectTimeCallback;
import com.aliyun.ayland.widget.pickerview.utils.ChinaDate;
import com.aliyun.ayland.widget.pickerview.utils.LunarCalendar;
...
public class WheelTime {
    ...
    private void setLunar(int year, final int month, int day, boolean isLeap, int h, int m, int s) {
        ...
        // 添加"年"监听
        wv_year.setATOnItemSelectedListener(new ATOnItemSelectedListener() {
            @Override
        ...
        // 添加"月"监听
        wv_month.setATOnItemSelectedListener(new ATOnItemSelectedListener() {
            @Override
            public void onItemSelected(int index) {
                int month_num = index;
    ...
    private void setChangedListener(WheelView WheelView) {
        if (mSelectChangeCallback != null) {
            WheelView.setATOnItemSelectedListener(new ATOnItemSelectedListener() {
                @Override
                public void onItemSelected(int index) {
                    mSelectChangeCallback.onTimeSelectChanged();
                }
