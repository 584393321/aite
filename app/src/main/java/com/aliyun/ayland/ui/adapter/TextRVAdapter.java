...
public class TextRVAdapter extends RecyclerView.Adapter{
    ...
    public TextRVAdapter(Activity context, List<String> list, boolean flag, String clazz) {
        mContext = context;
        this.list = list;
        this.flag = flag;
        this.clazz = clazz;
    ...
    public class TextHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(int position) {
            ...
            if(flag && position == list.size() - 1){
                tvText.setText("");
                Drawable drawable = mContext.getResources().getDrawable(R.drawable.at_icon_delete_32dp);
                tvText.setCompoundDrawablesWithIntrinsicBounds(drawable,null,null,null);
//                imageView.setVisibility(View.VISIBLE);
            }
            tvText.setOnClickListener(view -> mOnItemClickListener.onItemClick(view, tvText.getText().toString()));
        }
    }
